...
// /*  allocate_param                                                  */
// /*──────────────────────────────────────────────────────────────────*/
// bool DllMemoryManager::allocate_param(std::int64_t plugin_handler, bool is_output, VariableType type, const char*
// name,
...
// bool DllMemoryManager::allocate_param_static(void* self, std::int64_t plugin_handler, bool is_output, VariableType
// type,
//                                              const char* name, ...) {
//     va_list ap;
//     va_start(ap, name);
...
//     std::lock_guard<std::mutex> lk(mutex_);
//     std::size_t                 txt = 0, vec = vector_pool_.size(), vid = video_pool_.size(), aud =
//     audio_pool_.size(); for (auto& kv : text_pool_)
